...
internal open class AppCompatCheckBoxDescriptor : CheckBoxDescriptor() {

    override val intendedClass: Class<*>? = "androidx.appcompat.widget.AppCompatCheckBox".toClass()
}
