...
internal open class AlertControllerRecycleListViewDescriptor : ListViewDescriptor() {

    override val intendedClass: Class<*>? = "androidx.appcompat.app.AlertController\$RecycleListView".toClass()
}
