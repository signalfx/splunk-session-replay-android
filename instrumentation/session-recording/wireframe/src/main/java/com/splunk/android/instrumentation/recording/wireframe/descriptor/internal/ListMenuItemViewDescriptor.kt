...
internal open class ListMenuItemViewDescriptor : LinearLayoutDescriptor() {

    override val intendedClass: Class<*>? = "com.android.internal.view.menu.ListMenuItemView".toClass()
}
