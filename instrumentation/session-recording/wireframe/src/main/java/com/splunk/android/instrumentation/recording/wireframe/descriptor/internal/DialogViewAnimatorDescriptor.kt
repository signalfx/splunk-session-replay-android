...
internal open class DialogViewAnimatorDescriptor : ViewAnimatorDescriptor() {

    override val intendedClass: Class<*>? = "com.android.internal.widget.DialogViewAnimator".toClass()
}
