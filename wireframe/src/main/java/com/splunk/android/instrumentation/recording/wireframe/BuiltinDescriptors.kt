...
/**
 * Builtin [ViewDescriptor]s.
 *
 * They live in a separate class, so the descriptor classes are not loaded until the first extraction.
 */
internal object BuiltinDescriptors {

    fun create(): Collection<ViewDescriptor> {
        val descriptors: MutableCollection<ViewDescriptor> = ArrayList()
