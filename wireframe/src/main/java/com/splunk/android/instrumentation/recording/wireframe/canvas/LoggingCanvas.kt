...
internal class LoggingCanvas : Canvas {
    ...
    constructor(bitmap: Bitmap) : super(bitmap) {
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "constructor(bitmap: ${bitmap.toPrettyString()})")
    }
    ...
    override fun isHardwareAccelerated(): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "isHardwareAccelerated(): $result")
    ...
    override fun setBitmap(bitmap: Bitmap?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "setBitmap(bitmap: ${bitmap?.toPrettyString()})")
    }
    ...
    override fun getMaximumBitmapWidth(): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "getMaximumBitmapWidth(): $result")
    ...
    override fun getMaximumBitmapHeight(): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "getMaximumBitmapHeight(): $result")
    ...
    @Suppress("unused")
    fun save(saveFlags: Int): Int { // This is method override!
        val result = super.save()

        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "save(saveFlags: $saveFlags): $result")
    ...
    override fun saveLayer(bounds: RectF?, paint: Paint?, saveFlags: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayer(bounds: $bounds, paint: ${paint?.toPrettyString()}, saveFlags: $saveFlags): $result")
    ...
    override fun saveLayer(bounds: RectF?, paint: Paint?): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayer(bounds: $bounds, paint: ${paint?.toPrettyString()}): $result")
    ...
    override fun saveLayer(left: Float, top: Float, right: Float, bottom: Float, paint: Paint?, saveFlags: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayer(left: $left, top: $top, right: $right, bottom: $bottom, paint: ${paint?.toPrettyString()}, saveFlags: $saveFlags): $result")
    ...
    override fun saveLayer(left: Float, top: Float, right: Float, bottom: Float, paint: Paint?): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayer(left: $left, top: $top, right: $right, bottom: $bottom, paint: ${paint?.toPrettyString()}): $result")
    ...
    override fun saveLayerAlpha(bounds: RectF?, alpha: Int, saveFlags: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayerAlpha(bounds: $bounds, alpha: $alpha, saveFlags: $saveFlags): $result")
    ...
    override fun saveLayerAlpha(bounds: RectF?, alpha: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayerAlpha(bounds: $bounds, alpha: $alpha): $result")
    ...
    override fun saveLayerAlpha(left: Float, top: Float, right: Float, bottom: Float, alpha: Int, saveFlags: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayerAlpha(left: $left, top: $top, right: $right, bottom: $bottom, alpha: $alpha, saveFlags: $saveFlags): $result")
    ...
    override fun saveLayerAlpha(left: Float, top: Float, right: Float, bottom: Float, alpha: Int): Int {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "saveLayerAlpha(left: $left, top: $top, right: $right, bottom: $bottom, alpha: $alpha): $result")
    ...
    override fun restore() {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "restore() - saveCount: $saveCount")
    }
    ...
    override fun restoreToCount(saveCount: Int) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "restoreToCount(saveCount: $saveCount)")
    }
    ...
    override fun translate(dx: Float, dy: Float) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "translate(dx: $dx, dy: $dy)")
    }
    ...
    override fun concat(matrix: Matrix?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "concat(matrix: $matrix)")
    }
    ...
    override fun setMatrix(matrix: Matrix?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "setMatrix(matrix: $matrix)")
    }
    ...
    override fun clipRect(rect: RectF, op: Region.Op): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipRect(rect: $rect, op: $op): $result")
    ...
    override fun clipRect(rect: RectF): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipRect(rect: $rect): $result")
    ...
    override fun clipRect(left: Float, top: Float, right: Float, bottom: Float, op: Region.Op): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipRect(left: $left, top: $top, right: $right, bottom: $bottom, op: $op): $result")
    ...
    override fun clipRect(left: Float, top: Float, right: Float, bottom: Float): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipRect(left: $left, top: $top, right: $right, bottom: $bottom): $result")
    ...
    override fun clipOutRect(rect: RectF): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipOutRect(rect: $rect): $result")
    ...
    override fun clipOutRect(left: Float, top: Float, right: Float, bottom: Float): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipOutRect(left: $left, top: $top, right: $right, bottom: $bottom): $result")
    ...
    override fun clipPath(path: Path, op: Region.Op): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipPath(path: ${path.toPrettyString()}, op: $op): $result")
    ...
    override fun clipPath(path: Path): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipPath(path: ${path.toPrettyString()}): $result")
    ...
    override fun clipOutPath(path: Path): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "clipOutPath(path: ${path.toPrettyString()}): $result")
    ...
    override fun setDrawFilter(filter: DrawFilter?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "setDrawFilter(filter: $filter)")
    }
    ...
    override fun quickReject(rect: RectF, type: EdgeType): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(rect: $rect, type: $type): $result")
    ...
    override fun quickReject(rect: RectF): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(rect: $rect): $result")
    ...
    override fun quickReject(path: Path, type: EdgeType): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(path: ${path.toPrettyString()}, type: $type): $result")
    ...
    override fun quickReject(path: Path): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(path: ${path.toPrettyString()}): $result")
    ...
    override fun quickReject(left: Float, top: Float, right: Float, bottom: Float, type: EdgeType): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(left: $left, top: $top, right: $right, bottom: $bottom, type: $type): $result")
    ...
    override fun quickReject(left: Float, top: Float, right: Float, bottom: Float): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "quickReject(left: $left, top: $top, right: $right, bottom: $bottom): $result")
    ...
    override fun getClipBounds(bounds: Rect?): Boolean {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "getClipBounds(bounds: $bounds): $result")
    ...
    override fun drawPicture(picture: Picture) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPicture(picture: $picture)")
    }
    ...
    override fun drawPicture(picture: Picture, dst: RectF) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPicture(picture: $picture, dst: $dst)")
    }
    ...
    override fun drawArc(oval: RectF, startAngle: Float, sweepAngle: Float, useCenter: Boolean, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawArc(oval: $oval, startAngle: $startAngle, sweepAngle: $sweepAngle, useCenter: $useCenter, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawArc(left: Float, top: Float, right: Float, bottom: Float, startAngle: Float, sweepAngle: Float, useCenter: Boolean, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawArc(left: $left, top: $top, right: $right, bottom: $bottom, startAngle: $startAngle, sweepAngle: $sweepAngle, useCenter: $useCenter, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawARGB(a: Int, r: Int, g: Int, b: Int) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawARGB(a: $a, r: $r, g: $g, b: $b)")
    }
    ...
    override fun drawBitmap(bitmap: Bitmap, left: Float, top: Float, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawBitmap(bitmap: ${bitmap.toPrettyString()}, left: $left, top: $top, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawBitmap(bitmap: Bitmap, src: Rect?, dst: RectF, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawBitmap(bitmap: ${bitmap.toPrettyString()}, src: $src, dst: $dst, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawBitmap(colors: IntArray, offset: Int, stride: Int, x: Float, y: Float, width: Int, height: Int, hasAlpha: Boolean, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawBitmap(colors: $colors, offset: $offset, stride: $stride, x: $x, y: $y, width: $width, height: $height, hasAlpha: $hasAlpha, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawBitmap(bitmap: Bitmap, matrix: Matrix, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawBitmap(bitmap: ${bitmap.toPrettyString()}, matrix: $matrix, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawBitmapMesh(bitmap: Bitmap, meshWidth: Int, meshHeight: Int, verts: FloatArray, vertOffset: Int, colors: IntArray?, colorOffset: Int, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawBitmapMesh(bitmap: ${bitmap.toPrettyString()}, meshWidth: $meshWidth, meshHeight: $meshHeight, verts: $verts, vertOffset: $vertOffset, colors: $colors, colorOffset: $colorOffset, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawCircle(cx: Float, cy: Float, radius: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawCircle(cx: $cx, cy: $cy, radius: $radius, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawColor(color: Int) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawColor(color: $color)")
    }
    ...
    override fun drawColor(color: Int, mode: PorterDuff.Mode) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawColor(color: $color, mode: $mode)")
    }
    ...
    override fun drawLine(startX: Float, startY: Float, stopX: Float, stopY: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawLine(startX: $startX, startY: $startY, stopX: $stopX, stopY: $stopY, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawLines(pts: FloatArray, offset: Int, count: Int, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawLines(pts: $pts, offset: $offset, count: $count, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawLines(pts: FloatArray, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawLines(pts: $pts, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawOval(oval: RectF, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawOval(oval: $oval, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawOval(left: Float, top: Float, right: Float, bottom: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawOval(left: $left, top: $top, right: $right, bottom: $bottom, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPaint(paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPaint(paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPatch(patch: NinePatch, dst: Rect, paint: Paint?) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPatch(patch: $patch, dst: $dst, paint: ${paint?.toPrettyString()})")
    }
    ...
    override fun drawPath(path: Path, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPath(path: ${path.toPrettyString()}, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPoint(x: Float, y: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPoint(x: $x, y: $y, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPoints(pts: FloatArray?, offset: Int, count: Int, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPoints(pts: $pts, offset: $offset, count: $count, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPoints(pts: FloatArray, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPoints(pts: $pts, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPosText(text: CharArray, index: Int, count: Int, pos: FloatArray, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPosText(text: $text, index: $index, count: $count, pos: $pos, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawPosText(text: String, pos: FloatArray, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawPosText(text: $text, pos: $pos, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRect(rect: RectF, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRect(rect: $rect, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRect(r: Rect, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRect(r: $r, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRect(left: Float, top: Float, right: Float, bottom: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRect(left: $left, top: $top, right: $right, bottom: $bottom, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRoundRect(rect: RectF, rx: Float, ry: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRoundRect(rect: $rect, rx: $rx, ry: $ry, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRoundRect(left: Float, top: Float, right: Float, bottom: Float, rx: Float, ry: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRoundRect(left: $left, top: $top, right: $right, bottom: $bottom, rx: $rx, ry: $ry, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawDoubleRoundRect(outer: RectF, outerRx: Float, outerRy: Float, inner: RectF, innerRx: Float, innerRy: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawDoubleRoundRect(outer: $outer, outerRx: $outerRx, outerRy: $outerRy, inner: $inner, innerRx: $innerRx, innerRy: $innerRy, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawDoubleRoundRect(outer: RectF, outerRadii: FloatArray, inner: RectF, innerRadii: FloatArray, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawDoubleRoundRect(outer: $outer, outerRadii: $outerRadii, inner: $inner, innerRadii: $innerRadii, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawGlyphs(glyphIds: IntArray, glyphIdOffset: Int, positions: FloatArray, positionOffset: Int, glyphCount: Int, font: Font, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawGlyphs(glyphIds: $glyphIds, glyphIdOffset: $glyphIdOffset, positions: $positions, positionOffset: $positionOffset, glyphCount: $glyphCount, font: $font, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawText(text: CharArray, index: Int, count: Int, x: Float, y: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawText(text: $text, index: $index, count: $count, x: $x, y: $y, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawText(text: String, x: Float, y: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawText(text: $text, x: $x, y: $y, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawText(text: String, start: Int, end: Int, x: Float, y: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawText(text: $text, start: $start, end: $end, x: $x, y: $y, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawTextOnPath(text: CharArray, index: Int, count: Int, path: Path, hOffset: Float, vOffset: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawTextOnPath(text: $text, index: $index, count: $count, path: ${path.toPrettyString()}, hOffset: $hOffset, vOffset: $vOffset, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawTextOnPath(text: String, path: Path, hOffset: Float, vOffset: Float, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawTextOnPath(text: $text, path: ${path.toPrettyString()}, hOffset: $hOffset, vOffset: $vOffset, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawTextRun(text: CharArray, index: Int, count: Int, contextIndex: Int, contextCount: Int, x: Float, y: Float, isRtl: Boolean, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawTextRun(text: $text, index: $index, count: $count, contextIndex: $contextIndex, contextCount: $contextCount, x: $x, y: $y, isRtl: $isRtl, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawTextRun(text: CharSequence, start: Int, end: Int, contextStart: Int, contextEnd: Int, x: Float, y: Float, isRtl: Boolean, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawTextRun(text: $text, start: $start, end: $end, contextStart: $contextStart, contextEnd: $contextEnd, x: $x, y: $y, isRtl: $isRtl, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawVertices(mode: VertexMode, vertexCount: Int, verts: FloatArray, vertOffset: Int, texs: FloatArray?, texOffset: Int, colors: IntArray?, colorOffset: Int, indices: ShortArray?, indexOffset: Int, indexCount: Int, paint: Paint) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawVertices(mode: $mode, vertexCount: $vertexCount, verts: $verts, vertOffset: $vertOffset, texs: $texs, texOffset: $texOffset, colors: $colors, colorOffset: $colorOffset, indices: $indices, indexOffset: $indexOffset, indexCount: $indexCount, paint: ${paint.toPrettyString()})")
    }
    ...
    override fun drawRenderNode(renderNode: RenderNode) {
        ...
        if (IS_LOGGING_ENABLED)
            Log.d(TAG, "drawRenderNode(renderNode: $renderNode)")
    }

    companion object {
        private const val IS_LOGGING_ENABLED = true
        private const val TAG = "LoggingCanvas"
    }
}
