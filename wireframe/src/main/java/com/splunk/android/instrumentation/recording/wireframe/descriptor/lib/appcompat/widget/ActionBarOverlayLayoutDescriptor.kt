...
internal open class ActionBarOverlayLayoutDescriptor : ViewGroupDescriptor() {

    override val intendedClass: Class<*>? = "androidx.appcompat.widget.ActionBarOverlayLayout".toClass()
}
