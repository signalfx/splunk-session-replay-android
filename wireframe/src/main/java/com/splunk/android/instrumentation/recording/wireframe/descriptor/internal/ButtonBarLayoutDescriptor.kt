...
internal open class ButtonBarLayoutDescriptor : LinearLayoutDescriptor() {

    override val intendedClass: Class<*>? = "com.android.internal.widget.ButtonBarLayout".toClass()
}
